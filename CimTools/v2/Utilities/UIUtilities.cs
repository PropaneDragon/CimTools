...
namespace CimTools.v2.Utilities
{
    ...
    public class UIUtilities
    {
        ...
        public UIButton CreateButton(UIComponent parent)
        {
        ...
        public UICheckBox CreateCheckBox(UIComponent parent)
        {
        ...
        public UITextField CreateTextField(UIComponent parent)
        {
        ...
        public UIDropDown CreateDropDown(UIComponent parent, Vector2 size)
        {
        ...
        public UITextureAtlas defaultAtlas
        {
