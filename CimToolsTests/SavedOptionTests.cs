...
namespace CimToolsTests
{
    ...
    public class SavedOptionTests
    {
        ...
        {
            XmlFileManager fileManager = new XmlFileManager(new CimTools.V1.CimToolSettings("TestSaveLoad"));
        ...
        public void SaveLoadValues()
        {
            ...
            if (succeeded)
            {
                ...
                fileManager = new XmlFileManager(new CimTools.V1.CimToolSettings("TestSaveLoad"));
        ...
        {
            XmlFileManager fileManager = new XmlFileManager(new CimTools.V1.CimToolSettings("DoesntExist"));
